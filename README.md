...
## Workflow
- **Open** a PDF with the folder icon, then **Save** to download the annotated copy.
...
- Signatures are draggable once placed; reopen the identity dialog to redraw them at any time.
